<template lang="pug">
  .app-container.cdxq-content 
    .title
      h2 出动信息详情
        span(v-if="listData.cdxx")  (出动编号：{{listData.cdxx.cdbh}})
      .title_right
      ...
      .cdInfo(v-if="listData.cdxx")
        el-form(label-position="right")
          el-row(:gutter="60")
            ...
            el-col(:span="24")
              .shadow-box
                .title
                  ...
                  .right
                    span 隐藏非必选项&nbsp;
                    el-switch(v-model="value1" @click="hideNull")
                el-row(:gutter="60")
                  ...
                  el-col(:span="24" v-if="listData.cdxx.czqkdm=='01'")
                    el-row(:gutter="60")
                      ...
                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.cdsj?'hide':''")
                        el-form-item(label="出动时间")
                          span.item {{ listData.cdxx.cdsj || '-' }}

                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.zlsj?'hide':''")
                        el-form-item(label="中返时间")
                          span.item {{ listData.cdxx.zlsj || '-' }}

                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.fdsj?'hide':''")
                  ...
                  el-col(:span="24" v-else-if="listData.cdxx.czqkdm=='02'")
                    el-row(:gutter="60")
                      ...
                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.dcsj?'hide':''")
                        el-form-item(label="到场时间")
                          span.item {{ listData.cdxx.dcsj || '-' }}

                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.clsj?'hide':''")
                  ...
                  el-col(:span="24" v-else)
                    el-row(:gutter="60")
                      ...
                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.zksj?'hide':''")
                        el-form-item(label="展开时间")
                          span.item {{ listData.cdxx.zksj || '-' }}

                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.cssj?'hide':''")
                      ...
                      el-col(:xs="24" :sm="12" :lg="8" :span="8" v-if="listData.cdxx.czqkdm==3 && listData.cdxx.sjlbdm=='010000000000'")
                      ...
                      el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.jssj?'hide':''")
            ...
            el-col(:span="24")
              .shadow-box
                ...
                el-row(:gutter="60")
                  ...
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" v-if="listData.cdxx.sjlbdm=='010000000000' && listData.cdxx.czqkdm !== '01'")
                ...
                el-row(:gutter="60")
                  ...
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.sjlc?'hide':''")
                ...
                el-row(:gutter="60")
                  ...
                  el-col(:xs="24" :sm="12" :lg="8" :span="8"  v-if="listData.cdxx.sjlbdm=='010000000000'")
                    el-form-item(label="消防车通道是否堵塞")
                      span.item {{ listData.cdxx.isBlock == '1' ? "是" : "否" }}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8"  v-if="listData.cdxx.isBlock=='1'" )
                    el-form-item(label="疏通时间")
                      span.item {{ listData.cdxx.dredgeTime || "-" }} 分钟

                //- 带队指挥员 列表
                el-row(v-if="listData.cdxx.respondType=='010000'" :gutter="60" v-for="(item, index) in listData.ddzhy" :key="index")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.sjlc?'hide':''")
                ...
                el-row(v-if="listData.cdxx.respondType=='010000'" :gutter="60" v-for="(item, index) in listData.qqzhb" :key="item.qqzhbZhcddm")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.qqzhbZhcddm?'hide':''")
            ...
            el-col(:span="24")
              .shadow-box
                ...
                el-row(:gutter="60")
                  ...
                  el-col(:xs="24" :sm="12" :lg="6" :span="6" :class="value1 && !listData.cdxx.trrys?'hide':''")
                    el-form-item(label="人员（人）")
                      span.item 共 {{ listData.cdxx.trrys || ' - ' }} 人

                  el-col(:xs="24" :sm="12" :lg="6" :span="6" :class="value1 && !listData.cdxx.inCommander?'hide':''")
                    el-form-item(label="指挥员（人）")
                      span.item {{ listData.cdxx.inCommander || '-' }}

                  el-col(:xs="24" :sm="12" :lg="6" :span="6" :class="value1 && !listData.cdxx.inFireman?'hide':''")
            ...
            el-col(:span="24")
              .shadow-box
                ...
                el-row(v-if="listData.lddw.length>0" :gutter="60" v-for="(item, index) in listData.lddw" :key="item.lddwmc")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8")
                    el-form-item(:label="`联动单位名称${index + 1}`" :class="value1 && !item.lddwmc?'hide':''")
            ...
            el-col(:span="24" v-if="listData.mjjyd.length||listData.qyzzd.length")
              .shadow-box
                ...
                el-row(v-for="i in listData.mjjyd")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !getZyd(i.qtxfjyllFlBranch) ? 'hide' :'' ")
                    el-form-item(label="队伍性质")
                      span.item {{getZyd(i.qtxfjyllFlBranch) || '-'}}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !i.qtxfjyllMc ? 'hide' :'' ")
                    el-form-item(label="队伍名称")
                      span.item {{i.qtxfjyllMc || '-'}}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !i.renSl ? 'hide' :'' ")
                    el-form-item(label="人数")
                      span.item {{i.renSl || '-'}}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !i.cheSl ? 'hide' :'' ")
                    el-form-item(label="车（辆）")
                      span.item {{i.cheSl || '-'}}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !i.tingSl ? 'hide' :'' ")
                    el-form-item(label="艇（艘）")
                      span.item {{i.tingSl || '-'}}
                el-row(v-for="i in listData.qyzzd")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !getZzd(i.qtxfjyllFlBranch) ? 'hide' :'' ")
                    el-form-item(label="队伍性质")
            ...
            el-col(:span="24" v-if="listData.cdxx.czqkdm === '03' && (listData.cdxx.sjlbdm=='010000000000' || listData.cdxx.sjlbdm.substr(0,3) === '020')")
              .shadow-box
                .shadow-title 主要战术措施
                el-row
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && listData.cdxx.insideAttack != '1' && listData.cdxx.insideAttack != '0'?'hide':''")
            ...
            el-col(:span="24")
              .shadow-box
                .shadow-title 当日气象
                el-row
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.qw?'hide':''")
                    el-form-item(label="气温")
                      span.item {{listData.cdxx.qw || '-'}}℃
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.fxdm?'hide':''")
                    el-form-item(label="风向")
                      span.item {{getLabel("dicFx", listData.cdxx.fxdm) || '-'}}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.windForce?'hide':''")
                    el-form-item(label="风力")
                      span.item {{listData.cdxx.windForce || '-'}}级
                  el-col(:xs="24" :sm="12" :lg="8" :span="8")
                    el-form-item(label="天气" :class="value1 && !listData.cdxx.weather?'hide':''")
            ...
            el-col(:span="24" v-if="listData.cdxx.respondType=='010000' && listData.gov.length>0")
              .shadow-box
                ...
                el-row(v-for="(item, index) in listData.gov" :key="item.name")
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.name?'hide':''")
                    el-form-item(label="姓名")
                      span.item {{ item.name || '-' }}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.position?'hide':''")
            ...
            el-col(:span="24" v-if="listData.wxxfz.length")
              .shadow-box
                ...
                el-row(:gutter="60" v-for="(item, index) in listData.wxxfz" :key="item.qtxfjyllMc")
                  el-col(:xs="24" :sm="12" :lg="24" :span="24" :class="value1 && !item.qtxfjyllMc?'hide':''")
                    el-form-item(:label="`微型消防站名称${index+1}：`")
                      span.item {{ item.qtxfjyllMc || '-' }}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.cheSl?'hide':''")
                    el-form-item(label="车（辆）")
                      span.item {{ item.cheSl || '-' }}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.tingSl ? 'hide' : '' ")
                    el-form-item(label="艇（艘）")
                      span.item {{ item.tingSl || '-' }}
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.renSl?'hide':''")
              ...
              .shadow-box
                ...
                .people-box(v-for="(item, index) in listData.czryswInjured" :key="index")
                  el-row
                    ...
                    el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.personalCode?'hide':''")
                    ...
                    el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.ryxj?'hide':''")
                      el-form-item(label="衔级")
                        span.item {{ item.ryxj }}

                    el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !item.ryzj?'hide':''")
            ...
            el-col(:span="24" class="consumables")
              .shadow-box
                ...
                .show-body(v-if="consumablesShow")
                  .h4 —— 车辆损耗 ——
                  el-row
                    el-col(:span="24" :class="value1 && !listData.cdxx.damageEngine?'hide':''")
                      el-form-item(label="")
                        span.item {{ getListLabel('syscar', listData.cdxx.damageEngine) || '-' }}
                  .h4 —— 消耗用品 - 灭火器材 ——
                  el-row
                    ...
                    el-col(:span="24" v-for="(item, index) in listData.mhqcOther" :key="item.content" :class="value1 && !item.content?'hide':''")
                  ...
                  el-row
                    ...
                    el-col(:span="24" v-for="(item, index) in listData.grzbOther" :key="item.content" :class="value1 && !item.content?'hide':''")
                      el-form-item(:label="`其他物品${index + 1}`")
                        span.item {{ item.content }} {{ item.num || '-' }}
                  ...
                  el-row
                    ...
                    el-col(:span="24" v-for="(item, index) in listData.mhyjOther" :key="item.content" :class="value1 && !item.content?'hide':''")
                      el-form-item(:label="`其他物品${index + 1}`")
                        span.item {{ item.content }} {{ item.num || '-' }}
            ...
            el-col(:span="24" v-if="listData.cdxx.czqkdm === '03'")
              .shadow-box
                ...
                el-row(:gutter="60" :class="value1 && !listData.cdxx.czjg?'hide':''")
                  el-col(:span="24")
                    el-form-item(label="")
            ...
            el-col(:span="24" v-if="listData.cdxx.czqkdm !== '01'")
              .shadow-box
                .shadow-title 现场照片
                el-row(:gutter="60")
                  el-col(:span="24" :class="value1 && !listData.imgs?'hide':''")
            ...
            el-col(:span="24")
              .shadow-box
                .shadow-title 其他
                el-row(:gutter="60")
                  el-col(:span="24" :class="value1 && !listData.cdxx.annexName?'hide':''")
            ...
            el-col(:span="24" v-if="listData.cdxx.shzt == 4")
              .shadow-box
                ...
                el-row
                  ...
                  el-col(:xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !listData.cdxx.issueType?'hide':''")
            ...
            //- 审核专用
            audit(v-if="showAudit" :propfrom="propfrom")
  ...
  export default {
    ...
    watch: {
      querycdbh() {
        ...
        this.propfrom.cdbh = this.querycdbh;
    ...
    methods: {
      printf(){
        let subOutputRankPrint = document.getElementsByClassName('cdxq-content')[0];
      ...
      transformPageShowData(saveData) {
        ...
        // 审核专用
        this.showAudit = !!saveData.cdxx.shzt;
