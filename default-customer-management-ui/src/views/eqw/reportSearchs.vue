...
<script>
  ...
  import "@riophae/vue-treeselect/dist/vue-treeselect.css";
  import {getReportTemplateLv1, getReportTemplateLv2, getFireReport, synchronizeData, getSynchronizeDataTime, getLastEtlTime} from '@/api/report/report';
  //*****************固定报表查询
  import FixedReport from "./components/fixedReport";
  import CustomReport from "./components/customReport";
  export default {
    name:'fixedstatement',
    components: {provModal, mulModal, Treeselect,FixedReport,CustomReport},
    data() {
      return {
        activeName:'first',
        isLyao:'',
