<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="perms" align="left" label="权限标识" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" align="left" label="组件路径" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="visible" align="left" label="可见" width="80" :formatter="visibleFormat"></el-table-column>
