<template>
  <div v-loading="loading" class="page_zone">
    <div class="view-title">
     ...
     <el-button style="margin-right: 40px;" type="primary" @click="printf">打印</el-button>
    </div>
        ...
        >
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              ...
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.zqsj?'hide':''">
                <el-form-item label="起火时间">
                  <span>{{ form.zqsj || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.zqdd?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.zqlbdm?'hide':''">
                <el-form-item v-if="form.qwhz == '0'" label="火灾等级" prop="zqlbdm">
                  <span>{{ getLabel('tb_dic_zqdj', form.zqlbdm) }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.lxdh?'hide':''">
                <el-form-item label="失火单位/户主联系电话">
                  <span>{{ form.lxdh || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.dwtyshxydm?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.qydm?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.jdjcqk?'hide':''">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.sfbx != 0 && form.sfbx != 1?'hide':''">
                <el-form-item label="是否保险">
                  <span>{{ form.sfbx == '0' ? '是' : (form.sfbx == '1'? '否' : '-') }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.sfbxItems?'hide':''">
                <el-form-item label=" ">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.sfdfhzsh?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col v-if="form.qwhz == '0'" :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.sgqtdcbm?'hide':''">
                <el-form-item label="事故调查牵头部门" prop="sgqtdcbm">
                  <span>{{ getLabel('sgqtdcbm', form.sgqtdcbm) }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8">
                <el-form-item v-if="form.sgqtdcbm == '6'" label=" " :class="value1 && !form.sgqtdcbmItem1?'hide':''">
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="12" :span="8" :class="value1 && !form.qhcslb?'hide':''">
                <el-form-item label="起火场所类型" prop="qhcslb">
                  <span>{{ getLabel('tb_dic_qhcslb', form.qhcslb) }}</span>
                </el-form-item>
              </el-col>
              <el-col v-if="form.qhcslb" :span="12" :class="value1 && !form.qhcsms?'hide':''">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.sfyc != 0 && form.sfyc != 1?'hide':''">
                <el-form-item label="是否属于世界遗产">
                  <span>{{ form.sfyc == '0' ? '否' : (form.sfyc == '1' ? '是' : '-') }}</span>
                </el-form-item>
              </el-col>
              <el-col v-if="form.sfyc == '1'" :xs="24" :sm="12" :lg="6" :span="8" prop="sfsjycdm" :class="value1 && !form.sfsjycdm?'hide':''">
                <el-form-item label=" ">
            ...
            <el-row v-if="form.qwhz == '0' && form.qhcslb =='3'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" prop="jzsyyt" :class="value1 && !form.jzsyyt?'hide':''">
            ...
            <el-row v-if="form.qhcslb =='3'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.jzlbdm?'hide':''">
                <el-form-item label="建筑类别" prop="jzlbdm">
                  <span>{{ getLabel('tb_dic_jzlb', form.jzlbdm || '-' ) }}</span>
                </el-form-item>
              </el-col>
              <el-col v-if="form.qwhz == '0' && form.qhcslb =='3'" :xs="24" :sm="12" :lg="6" :span="8">
                <el-form-item label=" ">
            ...
            <el-row v-if="form.qhcslb =='3'" :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.jzjgdm?'hide':''">
                <el-form-item label="建筑结构" prop="jzjgdm">
                  <span>{{ getLabel('tb_dic_jzjg', form.jzjgdm) }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8" v-if="zzfw">
                <el-form-item label="房屋属性" prop="fwsx"  v-model = "form.fwsx">
                  <span>{{form.fwsx || '-'  }}</span>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="12" :lg="6" :span="8" v-if="zzfw">
                <el-form-item label="房屋建筑年份" prop="fwjznf"  v-model = "form.fwjznf" >
                  <span>{{  form.fwjznf || '-'  }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
          ...
          <div v-if="form.qwhz == '0'&&form.qhcslb==3" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.hzsfmydljjz != '0' && form.hzsfmydljjz != '1'?'hide':''">
                <el-form-item label="火灾蔓延到邻近建筑" prop="hzsfmydljjz">
                  <span>{{ form.hzsfmydljjz == '0' ? '否' : (form.hzsfmydljjz == '1' ? '是' : '-') }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.sffshr != '0' && form.sffshr != '1'?'hide':''">
                <el-form-item label="发生轰然" prop="sffshr">
                  <span>{{ form.sffshr == '0' ? '否' : (form.sffshr == '1' ? '是' : '-') }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.shjzmcsfkq != '0' && form.shjzmcsfkq != '1'?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.jzzlcs ?'hide':''">
                <el-form-item label="建筑总楼层数" prop="jzzlcs">
                  <span>{{ form.jzzlcs || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.shlc ?'hide':''">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="6" :class="value1 && !form.zdbjxtsfaz ?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :span="6" :class="value1 && !form.zdmhxtsfaz ?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :span="6" :class="value1 && !form.fpyxtsfaz ?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :span="6" :class="value1 && !form.fhjl ?'hide':''">
            ...
            <el-row :gutter="0">
              <el-col :span="6" :class="value1 && !form.snxhsxtsfaz ?'hide':''">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :span="8" :class="value1 && !form.sstd ?'hide':''">
              ...
              <el-col :span="8" :class="value1 && !form.yjck ?'hide':''">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :span="8" :class="value1 && !form.yjsszm ?'hide':''">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :span="6" :class="value1 && !form.sflw ?'hide':''">
                <el-form-item label="联网情况">
                  <span>{{ getLabel('sflw', form.sflw) }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6" :class="value1 && !form.sflwItem1 ?'hide':''">
                <el-form-item label=" ">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="0">
              <el-col :span="6" :class="value1 && form.sfdfhzsh != '2' && form.sfdfhzsh != '1'?'hide':''">
                <el-form-item label="是否单方火灾事故" >
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="12" :class="value1 && !form.qhwmsItem1 ?'hide':''">
                <el-form-item label="起火物" prop="qhwmsItem1">
                  <span>{{ form.qhwmsItem1 || '-' }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="12" :class="value1 && !form.qhwms ?'hide':''">
                <el-form-item label="起火物类型" prop="qhwms">
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="24" :lg="24" :span="8">
                <el-row :gutter="0">
                  <el-col :span="12" :class="value1 && !form.hzyyms ?'hide':''">
                  ...
                  <el-col :span="12" v-if="/其他$/.test(form.hzyyms)">
                    <el-form-item label="说明" prop="hzyymsItem1">
                      <span>{{ form.hzyymsItem1 || '-' }}</span>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-col>
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="调查方式" prop="dcfs" :class="value1 && !form.dcfs ?'hide':''">
            ...
            <el-row :gutter="0">
              ...
              <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !form.ssly ?'hide':''">
                <el-form-item label="损失来源">
                  <span>{{ getLabel('tb_dic_ssly', form.ssly) || '-' }}</span>
                </el-form-item>
              </el-col>
              <!-- <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="保护财产价值">
                  <span>{{ (form.protectPropVal || form.protectPropVal == 0) ? form.protectPropVal : '-' }}</span>
                </el-form-item>
              </el-col> -->
            </el-row>
            <el-row :gutter="0">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="21" :class="value1 && ishurt != '0' && ishurt != '1'?'hide':''">
            ...
            <div v-if="ishurt == 1" class="casualties_zone">
              <div class="hurt_zone">
                ...
                >
                  <el-row :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && element.swfl != '1' && element.swfl != '2'?'hide':''">
                      <el-form-item label="伤情">
                        <span>{{ element.swfl == '1' ? '轻伤' : (element.swfl == '2' ? '重伤' : '-') }}1人</span>
                      </el-form-item>
                    </el-col>
                  ...
                  <el-row :gutter="0" v-if="element.swfl == '2'">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.xm ?'hide':''">
                      <el-form-item label="人员姓名">
                        <!-- <el-input v-model="element.xm" placeholder :disabled="propfrom.isNotEdit" /> -->
                        <span>{{ element.xm || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.xb ?'hide':''"> 
                      <el-form-item label="人员性别">
                        <span>{{ getLabel('sys_user_sex', element.xb) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !mzpd(element.nation) ?'hide':''">
                      <el-form-item label="民族">
                        <span>{{ mzpd(element.nation) || '-' }}</span>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !zjlxpd(element.idType) ?'hide':''">
                      <el-form-item label="证件类型">
                        <span>{{ zjlxpd(element.idType) || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.sfzhm ?'hide':''">
                  ...
                  <el-row :gutter="0" v-if="element.swfl == '2'">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.nl ?'hide':''">
                      <el-form-item label="人员年龄">
                        <span>{{  element.nl || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.jkzkdm ?'hide':''">
                      <el-form-item label="健康状况">
                        <span>{{ getLabel('tb_dic_ryjkzk', element.jkzkdm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.swyydm ?'hide':''">
                  ...
                  <el-row :gutter="0" v-if="element.swfl == '2'">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.rklydm ?'hide':''">
                      <el-form-item label="来源">
                        <span>{{ getLabel('tb_dic_ryly', element.rklydm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.rklydm2 ?'hide':''">
                  ...
                  <el-row :gutter="0" v-if="element.swfl == '2'">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.zydm ?'hide':''">
                      <el-form-item label="职业">
                        <span>{{ getLabel('tb_dic_ryzy', element.zydm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !element.sjycddm ?'hide':''">
                      <el-form-item label="受教育程度">
              ...
              <div class="dead_zone">
                ...
                >
                  ...
                  <el-row :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="人员姓名" :class="value1 && !unit.xm ?'hide':''">
                        <span>{{ unit.xm || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.xb ?'hide':''">
                      <el-form-item label="人员性别">
                        <span>{{ getLabel('sys_user_sex', unit.xb) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !mzpd(unit.nation) ?'hide':''">
                      <el-form-item label="民族">
                        <span>{{ mzpd(unit.nation) || '-' }}</span>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !zjlxpd(unit.idType) ?'hide':''">
                      <el-form-item label="证件类型">
                        <span>{{ zjlxpd(unit.idType) || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.sfzhm ?'hide':''">
                      <el-form-item label="证件号码">
                        <span>{{ unit.sfzhm || '-' }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.sjycddm ?'hide':''">
                      <el-form-item label="受教育程度">
                        <span>{{ getLabel('tb_dic_rysjycd', unit.sjycddm) }}</span>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="0">
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.zydm ?'hide':''">
                      <el-form-item label="职业">
                        <span>{{ getLabel('tb_dic_ryzy', unit.zydm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.jkzkdm ?'hide':''">
                      <el-form-item label="健康状况">
                  ...
                  <el-row :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.swyydm ?'hide':''">
                      <el-form-item label="致死原因">
                        <span>{{ getLabel('tb_dic_swyy', unit.swyydm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.rklydm ?'hide':''">
                      <el-form-item label="来源">
                        <span>{{ getLabel('tb_dic_ryly', unit.rklydm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.rklydm2 ?'hide':''">
                      <el-form-item label="来源详情">
                  ...
                  <el-row v-if="unit.hasOwnProperty('swwzdm')" :gutter="0">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.swwzdm ?'hide':''">
                      <el-form-item label="发现尸体位置">
                        <span>{{ getLabel('tb_dic_swwz', unit.swwzdm) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8" :class="value1 && !unit.swsjdm ?'hide':''">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && form.sfla != '0' && form.sfla != '1' ?'hide':''">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col v-if="form.qwhz == '0'" :span="21" :class="value1 && isRegister!= '0' && isRegister != '1' ?'hide':''">
                <el-form-item label="是否立案">
            ...
            <div v-if="isRegister == 1">
              <div class="dw_zone">
                ...
                <el-row v-for="(item,index) in form.zqxxDwclList" :key="index" :gutter="0">
                  <el-col :span="7" :class="value1 && !form.zqxxDwclList[index].dwmc ?'hide':''">
                    <el-form-item label="单位名称">
                      <span>{{ form.zqxxDwclList[index].dwmc || '-' }}</span>
                    </el-form-item>
                  </el-col>
                  <el-col :span="7" :class="value1 && !form.zqxxDwclList[index].frdb ?'hide':''">
                    <el-form-item label="法人代表">
                      <span>{{ form.zqxxDwclList[index].frdb || '-' }}</span>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.zqxxDwclList[index].dwxzcfdm ?'hide':''">
              ...
              <div class="gr_zone">
                ...
                <el-row v-for="(item,index) in form.zqxxGrclList" :key="index" :gutter="0">
                  <el-col :span="7" :class="value1 && !form.zqxxGrclList[index].xm ?'hide':''">
                    <el-form-item label="姓名">
                      <span>{{ form.zqxxGrclList[index].xm || '-' }}</span>
                    </el-form-item>
                  </el-col>
                  <el-col :span="7" :class="value1 && !form.zqxxGrclList[index].xb ?'hide':''">
                    <el-form-item label="性别">
                      <span>{{ getLabel('sys_user_sex', form.zqxxGrclList[index].xb) }}</span>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="12" :lg="6" :span="8" :class="value1 && !form.zqxxGrclList[index].grxzcfdm ?'hide':''">
                    <el-form-item label="行政处罚">
          ...
          <div v-if="form.qwhz == '0' && form.sfxsfh == '1'" class="fire_building_describe">
            ...
            <el-row v-if="form.sfxsfh == '1'" :gutter="0">
              ...
              <el-col :span="24" :class="value1 && !form.zqxxXsfh.yjzlRemark ?'hide':''">
              ...
              <el-col :span="24" :class="value1 && !form.zqxxXsfh.ajjgRemark ?'hide':''">
              ...
              <el-col :span="24" :class="value1 && !form.zqxxXsfh.xcqkbgRemark ?'hide':''">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="24" :class="value1 && form.sfaqscsg != '0' && form.sfaqscsg != '1' ?'hide':''">
            ...
            <el-row v-if="form.sfaqscsg == '1'" :gutter="0">
              ...
              <el-col :span="24">
                <el-form-item label="有关政府文件描述" :class="value1 && !form.zqxxAqscsg.ygzfwjRemark ?'hide':''">
              ...
              <el-col :span="24" :class="value1 && !form.zqxxAqscsg.xcqkbgRemark ?'hide':''">
                <el-form-item label="现场情况报告描述">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="24" :class="value1 && !form.qtsm ?'hide':''">
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="0">
              <el-col :span="24" :class="value1 && !form.fireProcess ?'hide':''">
                <el-form-item  prop="fireProcess">
                  <span>{{ form.fireProcess || '-' }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
          <!-- 驳回信息 -->
          <div class="fire_building_describe" v-if="form.shzt == 4">
            ...
            <el-row :gutter="0">
              ...
              <el-col :span="8">
                <el-form-item label="问题类型" :class="value1 && !form.issueType ?'hide':''">
                  <span>{{ getLabel("issueType", form.issueType) }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="问题描述">
                  <span>{{ form.issueDesc }}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
          ...
          <div class="fire_building_describe" v-if="targetShowFlag">
            ...
            <el-row :gutter="50">
              ...
              <el-col class="btn-center" style="margin-top: 22px;text-align: center;">
  ...
  export default {
    ...
    data() {
      return {
        ...
        Options: {
          ...
          sstdItem1: [], jjckItem1: [], qydmItem2: [], jzsyyt: [], jzsyytItem1: [], swsjItem1: [], issueType: [],
          jzzlcs: '', // 建筑总楼层数
          shlc: '', // 失火楼层
          lxdh: '', // 电话
          dwtyshxydm: '' // 单位统一社会信用代码
      ...
      if (this.propfrom.type == '1' || this.propfrom.type == '3') {
        ...
        lszqDetailList({ zqbh: this.propfrom.zqbh })
          .then(res => {
            ...
            // if(!this.formData.fireProcess){
            //   this.formData.fireProcess = this.easyMessage;
            // }
            ...
            this.form.issueFlag = this.propfrom.type;
            if(this.formData.ssryList != null || this.formData.ssryList != []){
              this.hurtZsNumber = parseInt(this.formData.ssryList.filter(o => o.swfl == '2').length);
              this.hurtQsNumber = parseInt(this.formData.ssryList.filter(o => o.swfl == '1').length);
            }
    ...
    methods: {
      ...
      impotHurtPeople(val) {
        ...
        val == '1'
          ? this.form.swryList.push({
            ...
            zydm: '', sjycddm: '', swwzdm: '', swsjdm: '', swsjdmItem1: '', swyydm: '',swsjItem1:[],nation:'',idType:''})
      ...
      setSelectInfo() {
        ...
        //问题类型
        getSelectOptions("issue_type").then(res => {
          if (res.code == 200) {
            this.Options.issueType = res.data;
          } else {
            this.Options.issueType = [];
          }
        });
      },
      /**
      ...
      zjlxpd(value){
        ...
        let zjlx = [{key:'身份证',value:'1'},
          ...
          {key:'台湾通行证',value:'6'},
          {key:'护照',value:'7'}]
        zjlx = zjlx.filter(r=>r.value===value)
        return zjlx[0].key
      },
      /**
       * 民族转换
      ...
      mzpd(value){
        if(!value) return '';
        const na = nation.filter(r=>r.id===value)
        return na[0].name
      },
      printf(){
        let subOutputRankPrint = document.getElementsByClassName('page_zone')[0];
