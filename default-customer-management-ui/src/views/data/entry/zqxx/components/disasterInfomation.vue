        ...
        >
          <div class="fire_building_describe">
            <div class="display_flex">
              ...
              <div class="title_right">
                <span v-text="left_text"></span>
                <el-switch
                  v-model="value1"
                  inactive-text=""
                  active-text=""
                  @change="dianjiyincang"
                  >
                </el-switch>
            </div>
            </div>
            ...
            <el-row :gutter="50">
              ...
              <el-col v-show="xianyincang == '0' " ref="asd" :xs="24" :sm="12" :lg="8" :span="8">
            ...
            <el-row v-show="xianyincang == '0'" :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
            ...
            <el-row v-if="form.qwhz == '0' && xianyincang == '0'" :gutter="50">
              <el-col  :xs="24" :sm="12" :lg="8" :span="8">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="50">
              <el-col v-show="xianyincang == '0'" :xs="24" :sm="12" :lg="8" :span="8">
            ...
            <el-row :gutter="50">
              <el-col v-if="form.qwhz == '0' && xianyincang == '0'" :xs="24" :sm="12" :lg="8" :span="8">
          ...
          <div class="fire_building_describe">
            ...
            <el-row v-if="form.qhcslb =='3'" :gutter="50">
              <el-col v-show="form.qwhz == '0' && xianyincang == '0'" :xs="24" :sm="12" :lg="8" :span="8" prop="jzsyyt">
              ...
              <el-col v-if="form.qwhz == '0' && form.jzsyyt == '2'" :span="6" prop="jzsyytItem1">
                <el-form-item label=" ">
            ...
            <el-row v-if="form.qhcslb =='3'" :gutter="50">
              ...
              <el-col v-if="form.qhcsms == '自建住宅' || form.qhcsms == '员工集体宿舍' || form.qhcsms == '商品房' || form.qhcsms == '经适房' || form.qhcsms == '集资房' || form.qhcsms == '公寓房'" :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="房屋属性" prop="fwsx">
                  <el-select v-model="form.fwsx" placeholder="请选择" clearable :disabled="propfrom.isNotEdit">
                    <el-option
                      v-for="item in fwsxList"
                      :key="item.value"
                      :label="item.dictLabel"
                      :value="item.key"
              ...
              <el-col v-if="form.qhcsms == '自建住宅' || form.qhcsms == '员工集体宿舍' || form.qhcsms == '商品房' || form.qhcsms == '经适房' || form.qhcsms == '集资房' || form.qhcsms == '公寓房'" :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="房屋建筑年份" prop="fwjznf">
                  <el-input v-model="form.fwjznf" type="number" placeholder clearable :disabled="propfrom.isNotEdit" @blur="jzlcBlur" />
                </el-form-item>
              </el-col>
            </el-row>
          </div>
          ...
          <div v-if="form.qwhz == '0'&&form.qhcslb==3 && xianyincang == '0'" class="fire_building_describe">
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.qwhz == '0'" :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item v-show="xianyincang == '0'" label="引起火灾人员年龄">
                  <el-input-number
              ...
              <el-col v-if="form.qwhz == '0'" :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item v-show="xianyincang == '0'" label="受教育程度">
              ...
              <el-col v-if="form.qwhz == '0'" :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item v-show="xianyincang == '0'" label="健康状况">
          ...
          <div class="fire_building_describe" v-show="xianyincang == '0'">
          ...
          <div v-if="form.qwhz == '0'" class="fire_building_describe" v-show="xianyincang == '0'">
...
export default {
  ...
  data () {
    return {
      ...
      Options: {
        ...
        jznhdjdm: [], jzjgdm: [], fwsx: [], fhfq: [], fhjj: [], sstd: [], sflw: [], sflwItem1: [],
  ...
  methods: {
    ...
    dianjiyincang () {
      ...
      // this.$refs.zxc.style = "display:none;";
      if (this.xianyincang == '0') {
        // this.$refs.zxc.style = "display:none;";
        this.xianyincang = '1';
        this.left_text = '点击显示非必填项';
      } else {
        // this.$refs.zxc.style = "display:block;";
        this.xianyincang = '0';
        this.left_text = '点击隐藏非必填项';
      }
    },
    ...
    submitForm (formName) {
      ...
      // let zqsjjGetTime = new Date(zqsj).getTime();
      // if(zqsjjGetTime > jjsjGetTime){
      //   this.$message( "提示:起火时间早于接警时间.是否继续？");
      // }
      // this.reportForm();
