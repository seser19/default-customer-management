          ...
          <el-row :gutter="60">
            ...
            <el-col :xs="24" :sm="12" :lg="8" :span="8">
              <el-form-item label="119案件编号" prop="caseNbr">
                <el-input v-model="ruleForm.caseNbr" placeholder="请输入119案件编号" clearable ref="oon" :disabled="oonBl"/>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  import {getOptions, getJqcdlb, jqxxAdd4Jcj,getMappedJqxxDetail} from "@/api/data/entry/jqxx";
  // 责任区大队
        ...
        initt(){
            getMappedJqxxDetail(this.$route.query.id).then(res => {
                ...
                if(data.jqdj){
                  ...
                  }else if(data.jqdj == '二级'){
                    this.ruleForm.jqdj = 2
                  }else if(data.jqdj == '三级'){
                    this.ruleForm.jqdj = 3
                  }else if(data.jqdj == '四级'){
                    this.ruleForm.jqdj = 4
                  }else if(data.jqdj == '五级'){
                    this.ruleForm.jqdj = 5
                  }
                }
