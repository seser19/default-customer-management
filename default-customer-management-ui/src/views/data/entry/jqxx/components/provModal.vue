...
export default {
  ...
  methods: {
    ...
    modalSubmit() {
      ...
      if (this.checkedProv.type != "3" && this.checkedProv.type != "4"&& this.$route.path === "/data/entry/jqxxtb") {
        this.$message({
          message: "请完整选择地区",
          type: "warning"
        });
      ...
      // 数据查询页面特殊处理，直接赋值，每一级都可以选中
      if (this.checkedProv.type != "3" && this.checkedProv.type != "4" && this.$route.path === "/dataEntry/jqxxEdit") {
        this.$message({
          message: "请完整选择地区",
          type: "warning"
        });
      ...
      // 数据查询页面特殊处理，直接赋值，每一级都可以选中
      if (this.checkedProv.type != "3" && this.checkedProv.type != "4" && this.$route.path === "/dataEntry/jqxxPerfect") {
        this.$message({
          message: "请完整选择地区",
          type: "warning"
        });
      ...
      // 已审火灾页面特殊处理，直接赋值，每一级都可以选中
      if (this.checkedProv.type != "4" && this.$route.path === "/data/aduit/yscd") {
        this.$message({
          message: "请完整选择地区",
          type: "warning"
        });
