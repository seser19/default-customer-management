                ...
                >
                  ...
                  <fire-space-mul ref="qhcsSelect" :qhcsType="Options.qhcsType" @setMulVals="setQhcs"/>
                    ...
                    <el-row :gutter="60">
                        ...
                        <el-col :xs="24" :sm="12" :lg="8" :span="8" v-if="ruleForm.sjlbdm === '010000000000'  && xjID == false">
                        ...
                        <el-col :xs="24" :sm="12" :lg="8" :span="8" v-if="ruleForm.sjlbdm === '010000000000'  && xjID == true && ruleForm.isCorps == '0'">
                            <el-form-item label="责任区大队" prop="zrqdddm">
                                <el-input
                                    v-model="showValue.duty"
                                    placeholder="请选择"
                        ...
                        <el-col :span="24">
                            <el-form-item label="备注" v-if="zzhzjg == true" prop="bz">
                                <el-input
                                    type="textarea"
                                    v-model="ruleForm.bz"
                                    maxlength="300"
...
<script>
    ...
    export default {
        name: "alarmentry",
        components: {modal, mulModal, mainTeamModal, provModal, confirm,FireSpaceMul},
        data() {
        ...
        methods: {
            ...
            async getJqxxInfo(jqbh) {
                ...
                if (res.code == 200) {
                    ...
                    this.ruleForm.isCorps = res.data.isCorps;
                    // 责任区大队
            ...
            confirm() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        if(this.ruleForm.sjlbdm !== '010000000000'){
                            this.ruleForm.isCorps = '0';
                        }
                        if(this.ruleForm.isCorps == '1'){
