                ...
                el-table-column(prop="shzt" label="报告状态" width="100" sortable)
                    template(slot-scope="scope")
                        ...
                        .pic(v-if="scope.row.shzt == 99")
                            img(src="../../../icons/yiguidang.svg")
                            span 已归档
                        .pic(v-if="scope.row.shzt == 4")
                            img(src="../../../icons/tuihui.svg")
                            span 被驳回
                        //- span {{ shztdm(scope.row.shzt) }}
                el-table-column(prop="state" label="操作" width="100")
                    template(slot-scope="scope")
                        el-button(type="text" @click="jumpXq(scope.row)") 详情
                        el-button(type="text" :disabled="!(scope.row.shzt == -2 || scope.row.shzt == -1 || scope.row.shzt == -3 || scope.row.shzt == 4)" @click="editXq(scope.row)") 修改
    ...
    .app-container {
        .title {
            ...
            h2 {
                ...
                font-size: 18px;
                padding-left: 32px;
                background-image: url("./image/icon-hx.png");
