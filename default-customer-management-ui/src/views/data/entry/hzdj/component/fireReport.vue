    ...
    <div class="search">
      <el-form label-width="110px">
        ...
        <el-row :gutter="20">
          ...
          <!--              &lt;!&ndash; <el-input v-model="selectedOrgNames" readonly placeholder="请选择">-->
...
import {getbb} from "@/api/data/entry/hzdj";
import {
...
export default {
  ...
  data() {
    return {
      ...
      selectedTemplateType:'dj', //选择的报表类型
      templateTypeList:[{
        text:'登记',
        value:'dj'
      }],
  ...
  methods: {
    ...
    toggleTemplateType(){
      let templateOptionList = this.templateOption.filter(ele =>{
        if(this.selectedTemplateType==='dj'){
          return this.djLeva1.includes(ele.rptId)
        }else {
