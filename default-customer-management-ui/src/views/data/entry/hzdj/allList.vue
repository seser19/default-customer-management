<template>
  <zjxcdj v-if="sfzj"></zjxcdj>
  <div class="djList app-container" v-else-if="!sfzj">
      ...
      <div class="xcdjyl">
        ...
        >
          <tr>
            ...
            <td class="td4-2">{{ xcdjdata.bjsj }}</td>
            <td class="td4-1">起火单位/户主</td>
            <td class="td4-2">{{ xcdjdata.qhdw }}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>火灾发生经过</td>
            <td colspan="3">{{ xcdjdata.hzfsjg }}</td>
          </tr>
          <tr>
            <td>烧损物品</td>
            <td colspan="3">{{ xcdjdata.shwp }}</td>
          </tr>
          <tr>
            <td>火灾原因</td>
            <td>{{ xcdjdata.hzyy }}</td>
          ...
          <tr>
            <td>情况说明</td>
            <td>人员伤亡:{{ xcdjdata.sfrysw === 1 ? '是' : '否' }}</td>
            <td>保险情况:{{ xcdjdata.sfbx === 1 ? '是' : '否' }}</td>
            <td>纠纷情况:{{ xcdjdata.sfjf === 1 ? '是' : '否' }}</td>
          </tr>
          <tr>
            <td>当事人签名</td>
...
import zjxcdj from './zjxcdj.vue'

export default {
  name: 'allList',
  components: { FireSpaceMul: qhcs, areaSelect, fireReasonMul: hzyy,dateTimeRange ,zjxcdj},
