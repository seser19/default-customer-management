<template>
  <div v-loading="loading" class="page_zone disasterInfomation">
    <div class="title">
      ...
      <div v-if="propfrom.type == '1' && propfrom.isNotEdit">火灾信息详情</div>
      <div v-else>{{ $route.meta.title }}{{propfrom.jqbh == "" ? "（草稿）" : (form.qwhz == '1' ? "（轻微）" : "")}}
      </div>
            ...
            <el-row :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item v-if="form.qwhz == '0'" label="火灾等级" prop="zqlbdm">
                  <el-select v-model="form.zqlbdm" placeholder="请选择"
                             :disabled="propfrom.isNotEdit||propfrom.type=='1'||propfrom.qwhz=='0'">
                    <el-option
            ...
            <el-row :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="监督检查情况">
                  <el-select v-model="form.jdjcqk" placeholder :disabled="propfrom.isNotEdit"
                             @change="loadNext">
                    <el-option
          ...
          <div class="fire_building_describe">
            ...
            <el-row :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="起火场所类型" prop="qhcslb">
                  <el-select v-model="form.qhcslb" placeholder="请选择" :disabled="propfrom.isNotEdit"
                             @change="reset">
                    <el-option
              ...
              <el-col v-if="form.qhcslb" :span="16">
                <el-form-item label="起火场所" prop="qhcsms">
                  <el-input v-model="form.qhcsms" placeholder="请选择" readonly
                            :disabled="propfrom.isNotEdit">
            ...
            <el-row v-if="form.qwhz == '0' && form.qhcslb =='3'" :gutter="50">
              ...
              <el-col v-if="form.jzsyyt == '2'" :span="6" prop="jzsyytItem1">
                <el-form-item label=" ">
                  <el-select v-model="form.jzsyytItem1" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row v-if="form.qwhz == '0' && form.qhcslb =='3'" :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="建筑类别" prop="jzlbdm">
                  <el-select v-model="form.jzlbdm" placeholder="请选择" :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="建筑总楼层数" prop="jzzlcs">
                  <el-input v-model="form.jzzlcs" placeholder :disabled="propfrom.isNotEdit"/>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
          ...
          <div v-if="form.qwhz == '0'&&form.qhcslb==3" class="fire_building_describe">
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.zdbjxtsfazItem2 >= 7" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.zdbjxtsfazItem3" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.zdmhxtsfazItem2 >= 7 " :span="6" prop="zdmhxtsfazItem3">
                <el-form-item label=" ">
                  <el-select v-model="form.zdmhxtsfazItem3" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.fpyxtsfazItem2 >= 7" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.fpyxtsfazItem3" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.fhjlItem2 >= 7" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.fhjlItem3" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              ...
              <el-col v-if="form.snxhsxtsfazItem2 >= 7 && form.snxhsxtsfaz == '1'" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.snxhsxtsfazItem3" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="50">
              ...
              <el-col :span="5">
                <el-form-item label=" ">
                  <el-input v-model="form.fhfqIiem1" type="number" min="0"
                            :disabled="propfrom.isNotEdit">
              ...
              <el-col :span="5">
                <el-form-item label=" ">
                  <el-input v-model="form.fhjjItem1" type="number" min="0"
                            :disabled="propfrom.isNotEdit">
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="50">
              ...
              <el-col v-if="form.sstd == '2'" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.sstdItem1" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
              ...
              <el-col v-if="form.yjck == '2'" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.yjckItem1" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row v-if="form.qwhz == '0'" :gutter="50">
              ...
              <el-col v-if="form.yjsszm == '2'" :span="6">
                <el-form-item label=" ">
                  <el-select v-model="form.yjsszmItem1" placeholder="请选择"
                             :disabled="propfrom.isNotEdit">
                    <el-option
            ...
            <el-row :gutter="50">
              ...
              <el-col :xs="24" :sm="12" :lg="8" :span="8">
                <el-form-item label="损失来源" prop="ssly">
                  <el-select v-model="form.ssly" placeholder="请选择" :disabled="propfrom.isNotEdit"
                             clearable>
                    <el-option
            ...
            <div v-if="ishurt == 1" class="casualties_zone">
              <div class="hurt_zone">
                ...
                >
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="伤情" :prop="`ssryList.${index}.swfl`">
                        <el-select v-model="element.swfl" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit" @change="isZsTotal">
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="人员姓名" :prop="`ssryList.${index}.xm`">
                        <el-input v-model="element.xm" placeholder
                                  :disabled="propfrom.isNotEdit"/>
                      </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="人员性别" :prop="`ssryList.${index}.xb`">
                        <el-select v-model="element.xb" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="人员年龄" :prop="`ssryList.${index}.nl`">
                        <el-input-number
                          v-model="element.nl"
                          :min="0"
                          :max="Infinity"
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="健康状况" :prop="`ssryList.${index}.jkzkdm`">
                        <el-select v-model="element.jkzkdm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit" clearable>
                          <el-option
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="致伤原因" :prop="`ssryList.${index}.swyydm`">
                        <el-select v-model="element.swyydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="来源" :prop="`ssryList.${index}.rklydm`">
                        <el-select v-model="element.rklydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="来源详情" :prop="`ssryList.${index}.rklydm2`">
                        <el-select v-model="element.rklydm2" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="职业" :prop="`ssryList.${index}.zydm`">
                        <el-select v-model="element.zydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="受教育程度" :prop="`ssryList.${index}.sjycddm`">
                        <el-select v-model="element.sjycddm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit" clearable>
                          <el-option
              ...
              <div class="dead_zone">
                ...
                >
                  ...
                  <el-row :gutter="50">
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="人员性别" :prop="`swryList.${index}.xb`">
                        <el-select v-model="unit.xb" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                            v-for="(item, index) in Options.sys_user_sex"
                            :key="index"
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="职业" :prop="`swryList.${index}.zydm`">
                        <el-select v-model="unit.zydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                            v-for="(item, index) in Options.tb_dic_ryzy"
                            :key="index"
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="健康状况" :prop="`swryList.${index}.jkzkdm`">
                        <el-select v-model="unit.jkzkdm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit" clearable>
                          <el-option
                            v-for="(item, index) in Options.tb_dic_ryjkzk"
                            :key="index"
                  ...
                  <el-row :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="致死原因" :prop="`swryList.${index}.swyydm`">
                        <el-select v-model="unit.swyydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                            v-for="(item, index) in Options.tb_dic_swyy"
                            :key="index"
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="来源" :prop="`swryList.${index}.rklydm`">
                        <el-select v-model="unit.rklydm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                            v-for="(item, index) in Options.tb_dic_ryly"
                            :key="index"
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="来源详情" :prop="`swryList.${index}.rklydm2`">
                        <el-select v-model="unit.rklydm2" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                            v-for="(item, index) in Options.tb_dic_ryly2"
                            :key="index"
                  ...
                  <el-row v-if="unit.hasOwnProperty('swwzdm')" :gutter="50">
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="发现尸体位置" :prop="`swryList.${index}.swwzdm`">
                        <el-select v-model="unit.swwzdm" placeholder="请选择"
                                   :disabled="propfrom.isNotEdit">
                          <el-option
                    ...
                    <el-col :xs="24" :sm="12" :lg="8" :span="8">
                      <el-form-item label="死亡时间" :prop="`swryList.${index}.swsjdm`">
                        <el-select v-model="unit.swsjdm" placeholder="请选择"
                                   @change="swsjSelect(index,unit.swsjdm)">
                          <el-option
                ...
                <el-row v-for="(item,index) in form.zqxxDwclList" :key="index" :gutter="50">
                  <el-col :span="7">
                    <el-form-item label="单位名称">
                      <el-input v-model="form.zqxxDwclList[index].dwmc" placeholder
                                :disabled="propfrom.isNotEdit"/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="7">
                    <el-form-item label="法人代表">
                      <el-input v-model="form.zqxxDwclList[index].frdb" placeholder
                                :disabled="propfrom.isNotEdit"/>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="12" :lg="8" :span="8">
                    <el-form-item label="行政处罚">
                      <el-select v-model="form.zqxxDwclList[index].dwxzcfdm" placeholder="请选择">
                        <el-option
                ...
                <el-row v-for="(item,index) in form.zqxxGrclList" :key="index" :gutter="50">
                  <el-col :span="7">
                    <el-form-item label="姓名">
                      <el-input v-model="form.zqxxGrclList[index].xm" placeholder
                                :disabled="propfrom.isNotEdit"/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="7">
                    <el-form-item label="性别">
                      <el-select v-model="form.zqxxGrclList[index].xb" placeholder="请选择"
                                 :disabled="propfrom.isNotEdit">
                        <el-option
                          v-for="(item, index) in Options.sys_user_sex"
                          :key="index"
                  ...
                  <el-col :xs="24" :sm="12" :lg="8" :span="8">
                    <el-form-item label="行政处罚">
                      <el-select v-model="form.zqxxGrclList[index].grxzcfdm" placeholder="请选择"
                                 :disabled="propfrom.isNotEdit">
                        <el-option
                          v-for="(item, index) in Options.tb_dic_grxzcf"
                          :key="index"
            ...
            <el-row v-if="form.sfxsfh == '1'" :gutter="50">
              ...
              <el-col :span="24">
                <el-form-item label="移交资料描述">
                  <el-input v-model="form.zqxxXsfh.yjzlRemark" placeholder="请输入描述信息"
                            :disabled="propfrom.isNotEdit"/>
                </el-form-item>
              </el-col>
              <el-col :span="24">
              ...
              <el-col :span="24">
                <el-form-item label="案件结果描述">
                  <el-input v-model="form.zqxxXsfh.ajjgRemark" placeholder="请输入描述信息"
                            :disabled="propfrom.isNotEdit"/>
                </el-form-item>
              </el-col>
              <el-col :span="24">
              ...
              <el-col :span="24">
                <el-form-item label="现场情况报告描述">
                  <el-input v-model="form.zqxxXsfh.xcqkbgRemark" placeholder="请输入描述信息"
                            :disabled="propfrom.isNotEdit"/>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="24">
                <el-form-item label="有关政府文件描述">
                  <el-input v-model="form.zqxxAqscsg.ygzfwjRemark"   style="width:90%"
                            placeholder="请输入描述信息" :disabled="propfrom.isNotEdit"/>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="现场情况报告">
        ...
        if (this.form.qwhz == '0') {
          if (newZqlb != oldZqlb) {
            if(this.$route.query.isReject != '1'){
              let tipTxt = `您填写的条件火灾等级判定为${hzdjTxt}`;
              this.$alert(tipTxt, "提示", {
