                    ...
                    >
                        ...
                        <el-table-column prop="zqxxtb" label="火灾报告" width="110" :show-overflow-tooltip="true">
                            <template slot-scope="scope">
                                ...
                                <div
                                    v-if="(scope.row.sjlbdm.slice(0,2) == '01' || scope.row.sjlbdm == '070400000000')  && scope.row.isCorps !== '1'"
                        ...
                        <el-table-column label="操作" width="130">
                            <template slot-scope="scope">
                                ...
                                <el-button type="text" size="mini" @click="editDetail(scope.row)" v-hasPermi="['data:entry:jjxx-xq:update']" :disabled="scope.row.zt !== '4'">修改</el-button>
                                <el-button
                                    type="text"
                                    size="mini"
                                    @click="handleDelete(scope.row)"
                                    v-hasPermi="['data:entry:jjxx-xq:delete']"
                                    v-if="scope.row.jjsj.slice(0,4) !== '2019'  && scope.row.jjsj.slice(0,4) !== '2020'  && scope.row.jjsj.slice(0,4) !== '2021'"
                                >删除
                                </el-button>
                            </template>
                        </el-table-column>
...
<script>
    ...
    export default {
        ...
        components: {detail, disasterSituationReport, provModal,modal, dateTimeRange},
        props: [],
        data() {
            return {
                //初始显示
        ...
        created() {
            ...
            this.form.ksrq = getNearlyRecentYear(2019)[0].substr(0,10);
            this.form.jsrq = getNearlyRecentYear(2019)[1].substr(0,10);
