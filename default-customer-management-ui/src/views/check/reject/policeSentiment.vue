            ...
            <div class="content">
                ...
                <div class="table_zone">
                    ...
                    >
                            ...
                            <template slot-scope="props">
                                <el-table :data="props.row.jlist" style="width: 100%" :show-header="false">
                                    ...
                                    <el-table-column label="操作" width="100">
                                        <template slot-scope="scope">
                                            <el-link
                                                v-if="scope.row.cdbh && scope.row.shzt !== 0"
                                                type="primary"
                        ...
                        <el-table-column label="警情编号" width="150" sortable>
                            <template slot-scope="scope"><a style="color: #1890ff;" @click="checkDetail(scope.row)">{{scope.row.jqbh}}</a></template>
                        </el-table-column>
                        <el-table-column
                            prop="jjsj"
                            label="接警时间"
                        ...
                        <el-table-column prop="zqxxtb" label="火灾报告" width="110" :show-overflow-tooltip="true">
                            <template slot-scope="scope">
                                ...
                                <div
                                    v-if="scope.row.sjlbdm.slice(0,2) == '01' && scope.row.isCorps !== '1'"
                        ...
                        <el-table-column label="操作" width="130">
                            <template slot-scope="scope">
                                ...
                                <!-- <el-button type="text"  size="mini" @click="editDetail(scope.row.jqbh)">修改</el-button> -->
                                <!-- <el-button
                                                    type="text"
                                                    size="mini"
                                ...
                                <!-- 非 未送审、被驳回、归档、废弃 -->
                                <el-button
                                    v-if="scope.row.zt != '0' && scope.row.zt != '4' && scope.row.zt != '99' && scope.row.zt != '-99'"
                                    :disabled="scope.row.isKqy==='1'"
                                    type="text"
...
<script>
    ...
    import {jqReject} from "@/api/check/reject";
        ...
        methods: {
            ...
            submitTurnData(data) {
                ...
                if (data && data.finishDate) {
                    const params = {...data};
                    params.jqbh = this.turnDownCodes;
                    jqReject(params)
                        .then(res => {
                            const {msg, code} = res;
                            if (code === 200) {
